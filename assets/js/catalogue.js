/* ============================================================
   DATABRICKS GUIDE SERIES — catalogue data
   ------------------------------------------------------------
   STATUS VALUES
     "available"  green  · live on Gumroad, has a working CTA
...
const CATEGORIES = [
  { id:"ingestion",      n:"01", name:"Ingestion",                 accent:"teal",
    blurb:"Getting data in — and knowing when it didn't arrive." },
  { id:"storage",        n:"02", name:"Storage & Table Format",    accent:"cyan",
    blurb:"The table format, its log, its layout and the guarantees it carries." },
  { id:"transformation", n:"03", name:"Transformation & Processing", accent:"iris",
    blurb:"Pipelines, the engines beneath them, and what orchestrates it all." },
  { id:"governance",     n:"04", name:"Governance",                accent:"amber",
    blurb:"Who can see what, and how you prove it." },
  { id:"serving",        n:"05", name:"Serving, BI & Apps",        accent:"teal",
    blurb:"Warehouses, apps and dashboards on top of the lakehouse." },
  { id:"aiml",           n:"06", name:"AI & ML",                   accent:"iris",
    blurb:"Models, features, vectors and agents, from tracking to serving." },
  { id:"platform",       n:"07", name:"Platform & Operations",     accent:"cyan",
    blurb:"Deployment, cost, compute, and staying up when a region doesn't." },
  { id:"security",       n:"08", name:"Security & Networking",     accent:"orange",
    blurb:"Networking, identity, secrets and encryption." },
  { id:"migration",      n:"09", name:"Migration",                 accent:"amber",
    blurb:"Getting off the old thing without losing what protected you." },
];
...
{ id:3, cat:"ingestion", name:"Structured Streaming", pages:43, status:"soon",
...
{ id:4, cat:"ingestion", name:"COPY INTO", pages:42, status:"soon",
...
/* ══ 02 · STORAGE ════════════════════════════════════════ */
{ id:5, cat:"storage", name:"Delta Lake Performance & Maintenance", pages:45, status:"soon",
...
{ id:6, cat:"storage", name:"Delta Lake Internals", pages:41, status:"soon",
...
{ id:7, cat:"storage", name:"Change Data Feed", pages:41, status:"soon",
...
{ id:8, cat:"storage", name:"Iceberg on Databricks", pages:43, status:"soon",
...
{ id:9, cat:"storage", name:"Clone, Constraints & Generated Columns", pages:44, status:"soon",
...
/* ══ 03 · TRANSFORMATION ═════════════════════════════════ */
{ id:10, cat:"transformation", name:"Lakeflow Declarative Pipelines", pages:43, status:"soon",
...
{ id:11, cat:"transformation", name:"Spark on Databricks", pages:44, status:"soon",
...
{ id:12, cat:"transformation", name:"Lakeflow Jobs / Orchestration", pages:41, status:"soon",
...
{ id:13, cat:"transformation", name:"Photon", pages:41, status:"soon",
...
{ id:14, cat:"transformation", name:"UDFs", pages:44, status:"soon",
...
/* ══ 04 · GOVERNANCE ═════════════════════════════════════ */
{ id:15, cat:"governance", name:"Unity Catalog", pages:40, status:"soon",
...
{ id:18, cat:"governance", name:"Lakehouse Monitoring & Data Quality", status:"soon",
...
{ id:19, cat:"governance", name:"Audit Logs & System Tables", status:"soon",
...
{ id:20, cat:"governance", name:"Catalog Federation", status:"planned",
...
{ id:21, cat:"governance", name:"Clean Rooms", status:"soon",
...
{ id:22, cat:"governance", name:"Unity Catalog Metrics", status:"soon",
...
/* ══ 05 · SERVING, BI & APPS ═════════════════════════════ */
{ id:23, cat:"serving", name:"Lakebase", pages:46, status:"soon",
...
{ id:24, cat:"serving", name:"Databricks SQL Warehouses", status:"soon",
...
{ id:25, cat:"serving", name:"Databricks Apps", status:"soon",
...
{ id:26, cat:"serving", name:"AI/BI Dashboards", status:"soon",
...
{ id:27, cat:"serving", name:"AI/BI Genie", status:"planned",
...
/* ══ 06 · AI & ML ════════════════════════════════════════ */
{ id:28, cat:"aiml", name:"MLflow 3 & Model Lifecycle", status:"soon",
...
{ id:29, cat:"aiml", name:"Model Serving", status:"soon",
...
{ id:30, cat:"aiml", name:"Feature Engineering", status:"soon",
...
{ id:31, cat:"aiml", name:"Vector Search", status:"soon",
...
{ id:32, cat:"aiml", name:"Mosaic AI Agent Framework", status:"soon",
...
{ id:33, cat:"aiml", name:"Foundation Model APIs", status:"soon",
...
{ id:34, cat:"aiml", name:"Agent Bricks / Unity AI Gateway", status:"planned",
...
{ id:35, cat:"platform", name:"Databricks Asset Bundles / CI-CD", status:"soon",
...
{ id:36, cat:"platform", name:"Cost Management & FinOps", status:"soon",
...
{ id:37, cat:"platform", name:"Compute Configuration", status:"soon",
...
{ id:38, cat:"platform", name:"Observability & Monitoring", status:"soon",
...
{ id:39, cat:"platform", name:"Disaster Recovery", status:"soon",
...
{ id:40, cat:"platform", name:"Terraform Provider", status:"soon",
...
{ id:41, cat:"platform", name:"Serverless Compute", status:"soon",
...
{ id:42, cat:"platform", name:"CLI / SDK / REST API", status:"soon",
...
{ id:43, cat:"platform", name:"Git Folders & Dev Workflow", status:"soon",
...
{ id:44, cat:"security", name:"Networking", status:"soon",
...
{ id:45, cat:"security", name:"Identity & Access", status:"soon",
...
{ id:46, cat:"security", name:"Secrets Management", status:"soon",
...
{ id:47, cat:"security", name:"Encryption & CMK", status:"soon",
...
{ id:48, cat:"security", name:"Compliance Profiles", status:"soon",
...
/* ══ 09 · MIGRATION ══════════════════════════════════════ */
{ id:49, cat:"migration", name:"Hive Metastore → Unity Catalog", status:"soon",
...
{ id:50, cat:"migration", name:"DBFS Mounts → Volumes", status:"soon",
...
{ id:51, cat:"migration", name:"Snowflake / Synapse / Hadoop Migration", status:"soon",
...
/* ---- Release order (next up) -------------------------------- */

const NEXT_RELEASES = [2,3,4,5,6,7,8,13,15,23];
